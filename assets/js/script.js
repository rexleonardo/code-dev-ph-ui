    ...
    <div class="container">
        <div class="row footer-row1">
            <div class="col-12 col-sm-6 col-lg-3">
                <ul>
                    <span class="list-title">CodeDev//PH</span>
            ...
            <div class="col-12 col-sm-6 col-lg-3">
                <ul>
                    <span class="list-title">More</span>
        ...
        <div class="row footer-row2">
            <div class="col-12 col-md-12 col-lg-6 footer-copyright">
                <h1>CodeDev//PH</h1>
                <span>&copy; 2021 Code Development Philippines Inc. All rights reserved.</span>
            </div>
            <div class="col-12 col-md-12 col-lg-6 social-icons">
                <a href="https://www.facebook.com" target="_blank"><img src="./../assets/images/icons/facebook.svg" alt="facebook"></a>
                <a href="https://www.linkedin.com" target="_blank"><img src="./../assets/images/icons/linkedin.svg" alt="linkedin"></a>
                <a href="https://www.twitter.com" target="_blank"><img src="./../assets/images/icons/twitter.svg" alt="twitter"></a>
                <a href="https://www.youtube.com" target="_blank"><img src="./../assets/images/icons/youtube.svg" alt="youtube"></a>
                <a href="https://www.instagram.com" target="_blank"><img src="./../assets/images/icons/instagram.svg" alt="instagram"></a>
            </div>
        </div>
    </div>
`;
